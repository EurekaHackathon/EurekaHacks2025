    ...
    return (
        <div className="flex items-center justify-center h-screen">
            ...
            <div className="flex flex-col items-center font-[Agrandir]">
                ...
                <div className="flex flex-col text-6xl md:text-7xl font-bold tracking-widest m-0 text-five lg:hidden">
                ...
                <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-widest text-three m-4 text-center">MAY 2025</h2>
            </div>
